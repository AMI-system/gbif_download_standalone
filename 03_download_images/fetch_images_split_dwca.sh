...
#SBATCH --mem=100G
#SBATCH --output=download_madagascar.out
...
python fetch_images_split_dwca.py \
    ...
    --species_checklist "/bask/homes/f/fspo1218/amber/projects/gbif_download_standalone/species_checklists/madagascar-moths-keys-nodup.csv" \
    --max_data_sp 1000 \
    --skip_non_adults
